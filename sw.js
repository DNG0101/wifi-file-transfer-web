...
const CACHE='wft-shell-v21';
const SHELL=['./','./index.html','./assets/app.css?v=4.9.0','./assets/app.js?v=4.9.0-code1','./assets/hash-worker.js','./favicon.svg','./manifest.webmanifest','./connection-config.json'];
