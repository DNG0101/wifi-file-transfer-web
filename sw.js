...
const CACHE='wft-shell-v5';
const SHELL=['./','./index.html','./assets/app.js?v=3.1','./assets/app.css?v=3.1','./assets/hash-worker.js','./favicon.svg','./manifest.webmanifest','./connection-config.json'];
