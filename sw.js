...
const CACHE='wft-shell-v12';
const SHELL=['./','./index.html','./assets/app.css?v=4.4','./assets/app.js?v=4.6','./assets/hash-worker.js','./favicon.svg','./manifest.webmanifest','./connection-config.json'];
