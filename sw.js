...
const CACHE='wft-shell-v20';
const SHELL=['./','./index.html','./assets/app.css?v=4.9.0','./assets/app.js?v=4.9.0','./assets/hash-worker.js','./favicon.svg','./manifest.webmanifest','./connection-config.json'];
