...
const CACHE='wft-shell-v13';
const SHELL=['./','./index.html','./assets/app.css?v=4.4','./assets/app.js?v=4.6.1','./assets/hash-worker.js','./favicon.svg','./manifest.webmanifest','./connection-config.json'];
