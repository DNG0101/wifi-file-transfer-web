...
const CACHE='wft-shell-v6';
const SHELL=['./','./index.html','./assets/app.js?v=3.2','./assets/app.css?v=3.2','./assets/hash-worker.js','./favicon.svg','./manifest.webmanifest','./connection-config.json'];
