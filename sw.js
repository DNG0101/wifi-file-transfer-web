...
const CACHE='wft-shell-v16';
const SHELL=['./','./index.html','./assets/app.css?v=4.4','./assets/app.js?v=4.6.4','./assets/hash-worker.js','./favicon.svg','./manifest.webmanifest','./connection-config.json'];
