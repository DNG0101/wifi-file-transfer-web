...
const CACHE='wft-shell-v25';
const SHELL=['./','./index.html','./assets/app.css?v=4.13.0','./assets/app.js?v=4.13.0','./assets/hash-worker.js','./favicon.svg','./manifest.webmanifest','./connection-config.json'];
